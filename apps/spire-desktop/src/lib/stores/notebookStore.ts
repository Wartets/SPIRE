...
export const WIDGET_DEFINITIONS: WidgetDefinition[] = [
  { type: "model",      label: "Model Loader",        defaultColSpan: 1, defaultRowSpan: 2 },
  { type: "reaction",   label: "Reaction Workspace",  defaultColSpan: 1, defaultRowSpan: 2 },
  { type: "diagram",    label: "Diagram Visualizer",  defaultColSpan: 2, defaultRowSpan: 2 },
